...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ClickLog.click_url'
        db.alter_column(u'quotes_clicklog', 'click_url', self.gf('django.db.models.fields.TextField')(max_length=2000))
    ...
    models = {
        ...
        u'quotes.clicklog': {
            ...
            'click_url': ('django.db.models.fields.URLField', [], {'max_length': '2000'}),
